...
/* static char *font = "Cascadia Code:style=Light,Regular:pixelsize=15:antialias=true:autohint=true"; */
static char *font = "Fira Code,Fira Code Retina:style=Retina,Regular:size=12:antialias=true:autohint=true";
/* static char *font = "JetBrains Mono,JetBrains Mono Medium:style=Medium,Regular:size=12:antialias=true:autohint=true"; */
...
static char *openurlcmd[] = { "/bin/sh", "-c",
    "xurls | uniq | dmenu -l 10 | xargs -r process_url",
    "externalpipe", NULL };
